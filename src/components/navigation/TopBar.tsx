...
export function TopBar({
  ...
  return (
    ...
    >
      ...
      <nav aria-label="Instrument triggers" className="flex items-center gap-1.5 sm:gap-2">
        {/* Layer Panel Trigger */}
        <button
          type="button"
        ...
        >
          <span>INSPECT</span>
          <kbd className="hidden sm:inline-block text-[9px] text-aether-fg-muted bg-aether-bg px-1 py-0.5 rounded border border-aether-border-subtle">
            I
          </kbd>
        </button>
        ...
        <button
          ...
          className="h-7 sm:h-7.5 px-2 sm:px-2.5 rounded-sm border border-aether-border bg-aether-surface hover:bg-aether-surface-hover text-aether-fg-secondary text-[10.5px] sm:text-[11px] font-mono tracking-wider transition-colors flex items-center gap-1.5 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aether-accent focus-visible:ring-offset-1 focus-visible:ring-offset-aether-bg"
        >
          <svg
            className="w-3 h-3"
            viewBox="0 0 24 24"
